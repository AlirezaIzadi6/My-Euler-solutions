...
for i in range(17):
	for j in range(17):
		if data[i][j] * data[i][j+1] * data[i][j+2] * data[i][j+3] > max:
			max = data[i][j] * data[i][j+1] * data[i][j+2] * data[i][j+3]
		if data[i][j] * data[i+1][j] * data[i+2][j] * data[i+3][j] > max:
			max = data[i][j] * data[i+1][j] * data[i+2][j] * data[i+3][j]
			print('row {0}, column {1}'.format(i, j))
		if data[i][j] * data[i+1][j+1] * data[i+2][j+2] * data[i+3][j+3] > max:
